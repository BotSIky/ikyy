...
Jangann lupa ya kasih tq to nama gua "Arasyaa", yang mau recode izin ke gua dulu aja https://wa.me/6283870640443
...
banChats = false;
offline = false;
targetpc = "628387064043";
gopay = "0838-7064-0443";
limitawal = "900"
ovo = "0838-7064-0443";
pulsa = "038-7064-0443";
dana = "0838-7064-0443"
...
await syaa.setStatus(`פעיל ${uptime}`).catch((_) => _);
...
case "tod":
  if (isBanned) return reply(mess.ban)
					...
					sendButImage(from, arasyagans, "Case By @Ikyy Id 🗿", thumb, [
          {
...
case "suit":
  if (isBanned) return reply(mess.ban)
  sendButMessage(from, `Pilih Gunting Kertas Atau Batu`, `case By @Iky Id 🐦`, [
          {
...
case "report":
                    ...
                    syaa.sendMessage('6283870640443@s.whatsapp.net', options, text, {quoted: mek})
...
case "truth":
  if (isBanned) return reply(mess.ban)
					...
					sendButImage(from, ttrth, "Case By @Ikyy Id 🗿\nmau lagi? tekan tombol di bawah", thumb, [
          {
		...
		case "dare":
		  if (isBanned) return reply(mess.ban)
					...
					sendButImage(from, der, "Case By @Ikyy Id 🗿\nmau lagi? tekan tombol di bawah", thumb, [
          {
            buttonId: `${prefix}dare`,
            buttonText: {
              displayText: `Dare😆`,
...
║• ${prefix}fitnah
║• ${prefix}fitnahpc
║• ${prefix}kontak 62838706404438|iky
║• ${prefix}jadian
║• ${prefix}
║• ${prefix}tod
║• ${prefix}truth
...
║• ${prefix}s30` })
 ...
 if (!isOwner && !mek.key.fromMe) return reply(mess.own)
        ...
        case "surahmenu":
					// Fix Case by Arasyaaa
					sya = await getBuffer(`https://telegra.ph/file/27c4efb7d1b5f998da561.png`)
					syaa.sendMessage(from, sya,  image, { quoted: mek, caption: `*SURAH MENU الله*
║surah[AlFatihah] (واحد)
║surah[AlBaqarah] (اثنين)
║surah[AliImran] (ثلاثة)
║surah[AnNisa] (أربعة)
║surah[AlMaidah] (خمسة)
║surah[AlAnam] (ستة)
║surah[AlAraf] (سبعة)
║surah[AlAnfal] (ثمانية)
║surah[AnNas] (تسع)
║surah[AyatKursi] (عشرة)` })
					break
case "votemenu":
					// Fix Case by Arasyaaa
...
case "peraturan2":
					...
					syaa.sendMessage(from, sya, image, { quoted: mek, caption: `Bot merupakan suatu program bot whatsapp, yang menggunakan engine nodejs v14.x.x
Adapun ketentuan untuk memakai ky Bot. :
...
mentions(`┏━━⬣ 𝙄𝙉𝙁𝙊 \n┃ *Info :  ${q}*\n┃ •➢𝚃𝚘𝚝𝚊𝚕 𝙼𝚎𝚖𝚋𝚎𝚛 : ${groupMembers.length}*\n┃ •➢𝙽𝚊𝚖𝚊 𝙶𝚛𝚘𝚞𝚙 : ${groupName}*\n┗⬣\n\n┏━━⬣ 𝙏𝘼𝙂 𝘼𝙇𝙇\n┃`+teks+'┃\n┗⬣', members_id, false)
break
...
case "s30":
        if (!mek.key.fromMe) return
satu7 = fs.readFileSync('./30detik/s30.mp3');
syaa.sendMessage(from, satu7, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
      case "getbio":
...
case "stats":
              ...
              break
case "wa":
              fakestatus(`pencet link di bawah\n\nwa.me/6283870640443?text=Hai+Sayang`)
              break
case "email":
...
case 'tiktokvid':
    ...
    Follower: ${i.result.stats.followerCount}`;
      ...
      case "surahAlAnfal":
      case "surahAnNas":     
        sendButMessage(from, `Surah Find By @Ikyyyy🗿`, `press the button below`, [
          {
